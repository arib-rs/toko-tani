                    ...
                    if ($level == 1) { ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li id="lappenjualan-menu"><a href="<?= base_url('laporan/penjualan') ?>"><i class="fa fa-circle-o"></i> Penjualan</a></li>
                                <li id="lapadminsales-menu"><a href="<?= base_url('laporan/adminsales') ?>"><i class="fa fa-circle-o"></i> Admin/Sales</a></li>
