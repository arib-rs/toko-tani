                        ...
                        <form id="form-data">
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="row form-group">
                                        <label class="col-md-2 col-xs-3">Keterangan</label>
                                        <div class="col-md-10 col-xs-9">
                                            <textarea class="form-control" id="keterangan" name="keterangan" autocomplete="off"></textarea>                         
                                        </div>
                                    </div>                     
                                    <div class="row form-group" style="margin-bottom: 10px">
                                        <label class="col-md-2 col-xs-2">Nominal</label>
                                        <div class="col-md-4 col-xs-10">
                                            <input type="hidden" class="form-control text-right" id="debet" name="debet" maxlength="20" autocomplete="off">
    ...
    $(document).ready(function () {
        $('#tabs a[href="#list"]').click(function (e) {
            ...
            $('#dt-list').dataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?= base_url('Kas/ssplist_') ?>/pengeluaran',
                "bLengthChange": true,
                "aLengthMenu": [[10, 30, 50, -1], [10, 30, 50, "All"]],
                "iDisplayLength": 10,
                "bAutoWidth": false,
                "aaSorting": [],
                "columns": [{"width": "20%", "sClass": "text-center", "bSortable": false}, {"width": "50%", "bSortable": false}, {"width": "20%", "sClass": "text-right", "bSortable": false}, {"width": "10%", "sClass": "text-center", "bSortable": false}]
            });
            $(this).tab('show');
        });
        ...
        $('#tanggalfilter').datepicker({
            ...
            $('#dt-list').dataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?= base_url('Kas/ssplist_') ?>/pajak/' + $(this).val(),
                "bLengthChange": true,
                "aLengthMenu": [[10, 30, 50, -1], [10, 30, 50, "All"]],
                "iDisplayLength": 10,
                "bAutoWidth": false,
        ...
        $('#btn-save').click(function () {
            ...
            $.ajax({
                url: '<?= base_url('Kas/save_') ?>/pengeluaran',
                dataType: 'JSON',
                type: 'POST',
                data: dt,
                async: false,
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                form.find('#keterangan').val(result.kas_keterangan);
                    ...
                    success: function (result) {
                        if (result.ind == 1) {
                            ...
                            $('#dt-list').dataTable({
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?= base_url('Kas/ssplist_') ?>/pajak',
                                "bLengthChange": true,
                                "aLengthMenu": [[10, 30, 50, -1], [10, 30, 50, "All"]],
                                "iDisplayLength": 10,
                                "bAutoWidth": false,
