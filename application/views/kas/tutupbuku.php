<div class="content-wrapper">
    <section class="content-header">
        <h1>Rekapitulasi Kas Tutup Buku</h1>
        <ol class="breadcrumb">
            <li><a href="#">Laporan</a></li>
            <li class="active">Rekap Kas Tutup Buku</li>
        </ol>
    </section>
        ...
        <div class="row" style="margin-bottom: 10px">
            <form id="form-filter">
                ...
                <div class="col-md-1 col-xs-2">
                    <input id="tanggal" class="form-control text-center" name="tanggal" type="text" value="<?= date('Y') ?>" readonly="">
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-cari').click(function () {
            ...
            $.ajax({
                url: '<?= base_url('Tutupbuku/filterdata_') ?>',
                type: 'POST',
                data: dt,
                dataType: 'JSON',
                async: false,
        ...
        $('#btn-excel').click(function () {
            ...
            window.open('<?= base_url('Tutupbuku/excel_') ?>?' + dt, '_blank');
            i.removeClass().addClass(cls);
        });
        $('#btn-pdf').click(function () {
            ...
            i.removeClass().addClass('fa fa-spin fa-circle-o-notch');
            var form = $('#form-filter'), dt = form.serialize();
            window.open('<?= base_url('Tutupbuku/pdf_') ?>?' + dt, '_blank');
            i.removeClass().addClass(cls);
        });
    });
</script>