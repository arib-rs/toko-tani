<div class="content-wrapper">
    <section class="content-header">
        <h1>Rekapitulasi Pembelian <small>Menu untuk melihat daftar pembelian ke supplier</small></h1>
        <ol class="breadcrumb">
            <li><a href="#">Laporan</a></li>
            <li class="active">Rekap Pembelian</li>
        </ol>
    </section>
                        ...
                        <table id="dt-table" class="table table-bordered" style="margin-bottom: 0">
                            <thead class="bg-gray-active">
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 13%">Supplier</th>
                                    ...
                                    <!-- <th class="text-center" style="width: 15%">Pembayaran</th> -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn-cari').click(function() {
            ...
            $.ajax({
                url: '<?= base_url('Laporan/pembelianfilter_') ?>',
                type: 'POST',
                data: dt,
                dataType: 'JSON',
                async: false,
        ...
        $('#btn-pdf').click(function() {
            ...
            var form = $('#form-filter'),
                dt = form.serialize();
            window.open('<?= base_url('Laporan/pembelianpdf_') ?>?' + dt, '_blank');
            i.removeClass().addClass(cls);
        });
    });
</script>