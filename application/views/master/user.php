                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <form id="form-data">
                            ...
                            <div id="filterdaerah" class="row form-group hidden">
                        ...
                        <table id="dt-user" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 15%" class="text-center">Bagian</th>
                                    <th style="width: 15%" class="text-center">Daerah</th>
    ...
    $(document).ready(function() {
        ...
        $('#level').change(function() {
            if ($(this).val() == '0' || $(this).val() == '1' || $(this).val() == '2' || $(this).val() == '3') {
                ...
                $('#filterdaerah').addClass('hidden');
                $('#gudang').val('0');
                $('#daerah').val('0');
            } else {
                $('#filtersebagai').removeClass('hidden');
                $('#filterdaerah').removeClass('hidden');
            }
        });
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                form.find('#daerah').val(result.daerah);
