...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#barang-search').typeahead({
            ...
            source: function (query, process) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    dataType: 'JSON',
                    data: ({word: query, harga: $('#customer option:selected').data('harga')}),
        ...
        $('#form-search').submit(function (e) {
            e.preventDefault();
            var form = $(this);
            var id = form.find('#barang-id').val(), qty = form.find('#barang-qty').val();
            if (id == '') {
            ...
            if (tbody.find('tr#' + id).length > 0) {
                ...
                var nama = form.find('#barang-search').val(), satuan = form.find('#barang-satuan').val(), kode = form.find('#barang-kode').val(), hb = form.find('#barang-hb').val(), hj = form.find('#barang-hj').val(), stok = form.find('#barang-stok').val();
                ;
        ...
        $('#dt-produk').dataTable({
            ...
            "iDisplayLength": 10,
            "bAutoWidth": false,
            "columns": [{"width": "3%", "sClass": "text-center"}, {"width": "60%"}, {"width": "20%", "sClass": "text-right"}, {"width": "10%", "sClass": "text-center"}, {"width": "7%", "sClass": "text-center"}]
        });
        ...
        var disc = $('#diskon').val(), diskon = parseFloat(disc.replace(/,/g, ''));
        ...
        var disc = $('#diskon').val(), diskon = parseFloat(disc.replace(/,/g, ''));
        var gtotal = subtotal - diskon;
        var dp = $('#dp').val(), dp_ = parseFloat(dp.replace(/,/g, ''));
        var sisa = 0;
