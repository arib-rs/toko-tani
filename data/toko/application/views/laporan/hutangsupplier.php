<div class="content-wrapper">
    <section class="content-header">
        <h1>Laporan Hutang <small>Menu untuk melihat daftar hutang ke supplier</small></h1>
        <ol class="breadcrumb">
                ...
                <table id="dt-list" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead class="bg-gray-active">
                        <tr>
                            ...
                            <th style="width: 80%" class="text-center">Supplier</th>
                            <th style="width: 17%" class="text-center">Total Hutang</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#tahun').datepicker({
            ...
            $.ajax({
                url: '<?= base_url('Hutang/filter_') ?>/' + $(this).val(),
                dataType: 'JSON',
                async: false,
                beforeSend: function () {
